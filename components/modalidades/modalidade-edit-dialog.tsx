...
import { updateModalidade } from "@/app/actions/modalidades";
import { z } from "zod";
...
interface ModalidadeEditDialogProps {
  modalidade: Modalidade;
}

export function ModalidadeEditDialog({ modalidade }: ModalidadeEditDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateModalidade(modalidade.id, validData);
      setIsOpen(false);
    } catch (err) {
